...
def _get_bulge_sym_D(self, cand_data):
    ...
    """
    return float(sum(map(lambda r:
        _bulge_sym_D_helper(cand_data['seqs'][r], cand_data['bulgesl'][r], cand_data['pos'][r], cand_data['le']),
...
features['bulge_sym_D'].kl = range(10)
...
features['loop_dis_G'].kl = range(36)
...
"""
criteria = msc.Criteria(features, data_items)
